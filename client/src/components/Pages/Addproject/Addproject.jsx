...
{/* <!--Header--> */}
        <div  className="card-header  black-text text-center ">
            <h3><i className="mdi mdi-note-plus"></i> Add Project</h3>
        </div>
    ...
    <div className="card-body px-lg-5 pt-0  ">
        ...
        <div className="form-group mt-5">
            ...
            className="form-control"
             value={topic} 
            onChange={this.handleTopic} placeholder="Project topic"/>
            {/* <label htmlFor="form3"> */}
        ...
        <div className="form-group">
            ...
            name="department"
            value={department} 
            onChange={this.handleDepartment} placeholder="Project Deparment"/>
            {/* <label htmfor="form2">
        ...
        <div className="form-group">
            ...
            name="school" 
            value={school}
             onChange={this.handleSchool} placeholder="Institution"/>
            {/* <label htmlFor="form2"> 
        ...
        {/* <i className="fa fa-user prefix"></i> */}
            ...
            name="year"
             value={year}
              onChange={this.handleYear} placeholder="Project Year"/>
            {/* <label htmlFor="form3"> <i className="mdi mdi-note"></i>Project Year</label> */}
        </div>
                   
        <div className="form-group">
        
            <textarea type="text" id="form10" className="md-textarea form-control" rows="2" name='summary' value={summary} onChange={this.handleSummary} placeholder="&#x270d;Project Summary"></textarea>
...
{/*             
        ...
        <div className="text-center">
            <button id="drop" className="btn btn-pink mdi mdi-cloud-upload" onClick={this.handleSubmit}> &nbsp; Next</button>
