...
<div className="card-body px-lg-5 pt-0">
  ...
  (<p className="alert alert-warning" style={{display:'none'}}>{this.state.info}</p>) : (<p className="alert alert-danger">{this.state.info}</p>)}
    ...
    {/* <!-- Sign in button --> */}
    <button id="loginbtn" className="btn btn-outline-pink btn-rounded btn-block my-4 waves-effect z-depth-0 mt-5 mdi mdi-account-check" type="submit" onClick={this.handleSubmit}> Sign in
